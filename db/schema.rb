...
ActiveRecord::Schema.define(version: 20151104183754) do
  ...
  add_index "hangouts", ["event_id"], name: "index_hangouts_on_event_id", using: :btree
  ...
  add_foreign_key "hangouts", "events"
